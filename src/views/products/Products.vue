      ...
      <div class="box w-s12">
        <div class="box-title">
          ...
          <div class="box-actions">
            <a class="link" @click="this.addProduct"><i class="fas fa-plus r"/>Ajouter un produit</a>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
        <Table class="w-s12" v-bind:columns="{'reference':'Référence','name':'Nom','stock':'Stock restant','price':'Prix'}"
